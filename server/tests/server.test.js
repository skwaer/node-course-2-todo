...
describe('DELETE /todo:/id', () => {
	...
	it('should not delete a todo created by a different user', (done) => {
...
describe('PATCH /todo:/id', () => {
	...
	it('should not update when logged in as second user', (done) => {
		var id = todos[0]._id;
		var text = "test;"
		var changes = {
			text: text,
...
describe('POST /users/me/token', () => {
	it('should remove auth token on logout', (done) => {
		...
		// 200
		// end to find user verify that tokens array has lenght of 0
